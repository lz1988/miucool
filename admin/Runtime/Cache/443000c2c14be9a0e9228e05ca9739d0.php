...
<?php if(vo.id): ?><table width="100%" border="1">
<tr>
  <td width="150">文章名称</td>
  <td width="874"><label>
    <input type="text" name="newtitle"  value="<?php echo ($data["newtitle"]); ?>"id="newtitle" />
...
<tr>
  <td>文章内容</td>
  <td><textarea name="newcontent" id="newcontent" style="width:98%" rows="45"><?php echo ($data["newcontent"]); ?></textarea></td>
</tr>

<tr>
  <td>状态</td>
  <td><select name="isdel" id="isdel">
    <option value="0">启用</option>
    <option value="1" 
    <?php if($data["isdel"] == 1): ?>selected<?php endif; ?>
    >禁止
    </option>
  </select></td>
</tr>
